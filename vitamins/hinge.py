...
def build(
    ...
    hinge_length_total = (
        hinge_width - 2 * hinge_end_width - hinge_gap
    ) / hinge_internal_sections
    ...
    with BuildPart() as _hinge:
        with GridLocations(
            ...
            Cylinder(
                radius=hinge_dia / 2,
                height=hinge_end_width,
                rotation=(0, 90, 0),
                align=(Align.CENTER, Align.CENTER, Align.MIN),
            )
        end_cap_locations = list(_end_cap_locations)
        join_cone = Cone(
            bottom_radius=hinge_dia / 2,
            top_radius=cone_tip_dia / 2,
            height=cone_depth,
            rotation=(0, 90, 0),
            align=(Align.CENTER, Align.CENTER, Align.MIN),
            mode=Mode.PRIVATE,
